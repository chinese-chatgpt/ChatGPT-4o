...
- [https://chat.yixiaai.com/](https://chat.lanjing.pro/) - **ChatGPT中文版**，运营近2年，支持 GPT-4、4o 以及 o1，支持 AI 绘画，扫码即可使用。
...
1. 选择上方的网址，如：[https://chat.yixiaai.com/](https://chat.lanjing.pro/)。
2. 在左上角，点击登录（也可以直接提问）。
3. 弹出二维码后，使用微信扫码即可。
